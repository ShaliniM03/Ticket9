...
import EventSearchForm from "./(event-search-form)/EventSearchForm";
...
const HeroSearchForm2Mobile = () => {
  ...
  return (
    <div className="flex">
      <Logo className="w-24 self-center md:hidden" />
