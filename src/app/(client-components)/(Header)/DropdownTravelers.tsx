...
import EventsIcon from "@/images/events_icon.svg";
import EventsSvg from "@/icons/EventsIcon";
              ...
              <div className="overflow-hidden rounded-2xl shadow-lg ring-1 ring-black ring-opacity-5">
                <div className="relative grid grid-cols-1 gap-7 bg-white dark:bg-neutral-800 p-7 ">
                  {solutions.map((item, index) => (
                    ...
                    >
                      <div className="flex items-center justify-center flex-shrink-0 w-10 h-10 bg-tone-beige rounded-md text-primary-500 sm:h-12 sm:w-12">
                        <item.icon aria-hidden="true" />
                        {/* <Image src={EventsIcon} alt="React Logo" /> */}
                      </div>
