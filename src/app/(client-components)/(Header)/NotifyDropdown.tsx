...
const notifications = [
  {
    name: "Admin",
    description: "Ticket 9 Next is getting ready! Stay Tuned!",
    time: "3 minutes ago",
    href: "##",
    avatar: avatar4,
  },
      ...
      <Popover className={`relative flex ${className}`}>
        {({ open }) => (
          <>
            ...
            >
              <span className="w-2 h-2 bg-primary-red absolute top-2 right-2 rounded-full"></span>
                  ...
                  <div className="relative grid gap-8 bg-white dark:bg-neutral-800 p-7">
                    ...
                    {notifications.map((item, index) => (
                      ...
                      >
                        ...
                        <span className="absolute right-1 top-1/2 transform -translate-y-1/2 w-2 h-2 rounded-full bg-primary-red"></span>
                      </a>
                    ))}
                  </div>
                </div>
