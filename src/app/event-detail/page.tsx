...
import { TicketProps } from "@/data/ticket";
import { TICKET_DEMO } from "@/data/ticket";
...
const ListingStayDetailPage: FC<ListingStayDetailPageProps> = ({}) => {
      ...
      <div className="listingSection__wrap !space-y-6">
        ...
        <div className="flex items-center space-x-4">
          <span>
            ...
            <span className="ml-1"> Mar 18 - Apr 16 | 12:00 AM (IST)</span>
          </span>
        </div>
  ...
  const _renderTicket = (item: TicketProps, index: number) => {
    return (
      ...
      >
            ...
            >
              <span>
                ...
                {item.availableSeats < 3 && (
                  <span className={`py-2.5 pr-3 text-xs text-orange-400`}>
                    Sold out!
                  </span>
                )}
              </span>
              <span className={`flex items-center`}>
                <span className={`py-2.5 pr-3 `}>{item.price}</span>
                <ChevronDownIcon
        ...
        <Disclosure.Panel>
          <div className="p-2 pl-6 text-sm">{item.desc}</div>
        </Disclosure.Panel>
      </Disclosure>
    );
  };
  ...
  const renderTicketSection = () => {
    return (
      <div className="listingSection__wrap">
        ...
        <ul className="flex flex-col pb-2 pt-0 px-2 space-y-1">
    ...
    return (
      <div className="listingSection__wrap">
        ...
        <div className="flex items-center space-x-4">
          ...
          />
          <div>
            <span className="block text-xl font-medium">Kevin Francis</span>
  ...
  const renderThingToKnowSection = () => {
    return (
      <div className="listingSection__wrap">
        {/* HEADING */}
      ...
      <div className="listingSectionSidebar__wrap shadow-xl">
        ...
        <div className="flex justify-between">
          <span className="text-3xl font-semibold">
            <span className="mr-1 text-base font-normal text-neutral-500 dark:text-neutral-400">
              from
            </span>
            ₹200
          </span>
